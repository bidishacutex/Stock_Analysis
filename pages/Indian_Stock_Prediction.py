...
st.set_page_config(
    page_title="Indian Stock Prediction",
    page_icon=":bar_chart:",
    layout="wide"
)

st.title("Indian Stock Prediction (NSE)")

# Layout for user input
col1, col2, col3 = st.columns(3)

with col1:
    ticker_input = st.text_input('NSE Stock Ticker (Example: RELIANCE)', 'RELIANCE')
    ticker = f"{ticker_input.upper()}.NS"  # Appending NSE suffix automatically
