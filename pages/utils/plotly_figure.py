...
#     fig. update_layout(showlegend = False, height = 500, margin=dict (l=0, r=20, t=20, b=0), plot_bcolor = 'white', paper_bgcolor = '#e1efff')
#     return fig
...
# def Moving_average (dataframe, num_period):
#     dataframe ['SMA_50'] = pta. sma (dataframe [ 'Close'],50)
#     lataframe = filter_data(dataframe, num_period)
#     fig = go.Figure()
